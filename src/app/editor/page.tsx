...
export default function Home() {
  return (
    <div className="w-full bg-black text-white">
      ...
      {/* Feature Section 1 */}
      <div className="w-full min-h-96 bg-[#1A1A1A] flex items-center justify-between gap-12 px-10">
        <div className="flex flex-col gap-4 text-left">
          <h4 className="text-sm font-semibold uppercase text-gray-400 -mb-2">
            Anywhere & anytime
          </h4>
          <h2 className="text-4xl text-white font-bold">
            Zero-setup online editor <br />
            with version control and live preview
          </h2>
          <h4 className="text-gray-400 text-md">
            Create and manage your projects directly in the <br /> browser – no
            local setup required.
          </h4>
          <h4 className="text-gray-400 text-md">
            Real-time sync and change history so <br /> your whole team always
            stays in context.
          </h4>
      ...
      {/* Feature Section 2 */}
      <div className="w-full min-h-96 bg-[#739CFC] text-black flex items-center justify-between gap-12 px-10">
        <div>
          <img
            src="landing1.png"
            className="w-3xl rounded-xl shadow-lg transition-transform duration-300 hover:scale-105"
        ...
        <div className="flex flex-col gap-4 text-left">
          ...
          <h4 className="text-md">
            Your sessions run in the cloud and can be resumed <br /> from any
            browser at any time.
          </h4>
      ...
      {/* Feature Section 3 */}
      <div className="w-full min-h-96 bg-[#8ADC79] text-black flex items-center justify-between gap-12 px-10">
        <div className="flex flex-col gap-4 text-left">
          <h4 className="text-sm font-semibold uppercase -mb-2">
            Live collaboration
          </h4>
          ...
          <h4 className="text-md">
            Multiple users can edit and preview code together <br />
            with full version history and diff previews.
          </h4>
